...
public class GameOver_Win extends JFrame {
	...
	public GameOver_Win( int p ) {// si es 1 entonces gano, 0 caso contrario :)
		...
		tryAgain.setIcon(new ImageIcon(GameOver_Win.class.getResource("/GraficasSpritesExtra/tryAgain"+pantalla+".png")));
		...
		salir.setIcon(new ImageIcon(GameOver_Win.class.getResource("/GraficasSpritesExtra/salir"+pantalla+".png")));
		salir.setBounds(669, 527, 184, 49);
		contentPane.add(salir);
		
		JLabel gameOver = new JLabel("");
		gameOver.setIcon(new ImageIcon(GameOver_Win.class.getResource("/GraficasSpritesExtra/pantalla"+pantalla+".gif")));
